...
ขยายเพิ่มครุภัณฑ์สำนักงาน 5 หมวด ได้แก่ โต๊ะสำนักงาน เก้าอี้สำนักงาน ตู้เอกสาร เครื่องปรับอากาศ และเครื่องฉายภาพ พร้อมชื่อทรัพย์สิน ราคา จุดติดตั้ง ผู้รับผิดชอบ วันสิ้นสุดประกัน และช่องเฉพาะประเภท เช่น วัสดุ/ขนาด, BTU หรือความสว่าง/ชั่วโมงหลอดภาพ

ข้อมูลเริ่มต้นเป็น **ข้อมูลสมมติ 130 รายการ รวม 13 หมวด หมวดละ 10 รายการ** ไม่ใช่ทะเบียนหรือบุคลากรจริง ดูประเภทข้อมูลและปีอ้างอิงใน `data/manifest.json` รายละเอียดและคอลัมน์อยู่ใน `data/schema.json` การเพิ่ม/แก้ไขและประวัติบันทึกใน sessionStorage ของแท็บนั้น กดคืนค่าตัวอย่างเพื่อเริ่มใหม่ ค้นหาทุกช่องข้อมูล กรองประเภท/หน่วยงาน/สถานะ/อายุ จัดเรียง แบ่งหน้า เปิดรายละเอียดและแก้ไขได้ CSV ส่งออกเฉพาะรายการตามตัวกรองและป้องกันข้อมูลถูกตีความเป็นสูตร
...
ทดสอบด้วย `npm run test:assets` ตรวจช่องรายละเอียดครบทั้ง 13 หมวด ค้นหา/กรอง/แบ่งหน้า แก้ไขและคงข้อมูล รวมถึงราคาแบบทศนิยมและวันที่รับประกัน ป้องกันเลขครุภัณฑ์ซ้ำ CSV ตามตัวกรอง รายงาน ประวัติ คืนค่า หน้าจอมือถือ/แท็บเล็ต และทั้ง CSP ของ backend กับเส้นทาง GitHub Pages
