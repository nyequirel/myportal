...
ยังต้องตั้ง GitHub repository จริง, บัญชีเจ้าของ, SMTP และ hosting backend ก่อนใช้งานจริง การทดสอบอัตโนมัติใช้อีเมลจำลอง ไม่ได้ยืนยันการส่งถึง inbox ของผู้ให้บริการจริง
